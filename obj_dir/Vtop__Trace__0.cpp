...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
                                  ...
                                  << 0x18U) | ((vlSelf->top__DOT__DataMem__DOT__data_mem_array
                                               ...
                                               | ((vlSelf->top__DOT__DataMem__DOT__data_mem_array
                                                  ...
                                                  (0xfffffU 
                                                   & ((IData)(3U) 
                                                      + vlSelf->top__DOT__ALUresult))])))),32);
        bufp->chgIData(oldp+43,((0xfffffU & vlSelf->top__DOT__ALUresult)),20);
        bufp->chgIData(oldp+44,(vlSelf->top__DOT__pcreg__DOT__branch_PC),32);
        bufp->chgIData(oldp+45,(vlSelf->top__DOT__pcreg__DOT__inc_PC),32);
        bufp->chgIData(oldp+46,(vlSelf->top__DOT__pcreg__DOT__next_PC),32);
        ...
        bufp->chgCData(oldp+49,((0x1fU & (vlSelf->top__DOT__Instr 
                                          >> 7U))),5);
        bufp->chgIData(oldp+50,(vlSelf->top__DOT__read_data1__DOT__mem_array[0]),32);
        bufp->chgIData(oldp+51,(vlSelf->top__DOT__read_data1__DOT__mem_array[1]),32);
        bufp->chgIData(oldp+52,(vlSelf->top__DOT__read_data1__DOT__mem_array[2]),32);
        bufp->chgIData(oldp+53,(vlSelf->top__DOT__read_data1__DOT__mem_array[3]),32);
        bufp->chgIData(oldp+54,(vlSelf->top__DOT__read_data1__DOT__mem_array[4]),32);
        bufp->chgIData(oldp+55,(vlSelf->top__DOT__read_data1__DOT__mem_array[5]),32);
        bufp->chgIData(oldp+56,(vlSelf->top__DOT__read_data1__DOT__mem_array[6]),32);
        bufp->chgIData(oldp+57,(vlSelf->top__DOT__read_data1__DOT__mem_array[7]),32);
        bufp->chgIData(oldp+58,(vlSelf->top__DOT__read_data1__DOT__mem_array[8]),32);
        bufp->chgIData(oldp+59,(vlSelf->top__DOT__read_data1__DOT__mem_array[9]),32);
        bufp->chgIData(oldp+60,(vlSelf->top__DOT__read_data1__DOT__mem_array[10]),32);
        bufp->chgIData(oldp+61,(vlSelf->top__DOT__read_data1__DOT__mem_array[11]),32);
        bufp->chgIData(oldp+62,(vlSelf->top__DOT__read_data1__DOT__mem_array[12]),32);
        bufp->chgIData(oldp+63,(vlSelf->top__DOT__read_data1__DOT__mem_array[13]),32);
        bufp->chgIData(oldp+64,(vlSelf->top__DOT__read_data1__DOT__mem_array[14]),32);
        bufp->chgIData(oldp+65,(vlSelf->top__DOT__read_data1__DOT__mem_array[15]),32);
        bufp->chgIData(oldp+66,(vlSelf->top__DOT__read_data1__DOT__mem_array[16]),32);
        bufp->chgIData(oldp+67,(vlSelf->top__DOT__read_data1__DOT__mem_array[17]),32);
        bufp->chgIData(oldp+68,(vlSelf->top__DOT__read_data1__DOT__mem_array[18]),32);
        bufp->chgIData(oldp+69,(vlSelf->top__DOT__read_data1__DOT__mem_array[19]),32);
        bufp->chgIData(oldp+70,(vlSelf->top__DOT__read_data1__DOT__mem_array[20]),32);
        bufp->chgIData(oldp+71,(vlSelf->top__DOT__read_data1__DOT__mem_array[21]),32);
        bufp->chgIData(oldp+72,(vlSelf->top__DOT__read_data1__DOT__mem_array[22]),32);
        bufp->chgIData(oldp+73,(vlSelf->top__DOT__read_data1__DOT__mem_array[23]),32);
        bufp->chgIData(oldp+74,(vlSelf->top__DOT__read_data1__DOT__mem_array[24]),32);
        bufp->chgIData(oldp+75,(vlSelf->top__DOT__read_data1__DOT__mem_array[25]),32);
        bufp->chgIData(oldp+76,(vlSelf->top__DOT__read_data1__DOT__mem_array[26]),32);
        bufp->chgIData(oldp+77,(vlSelf->top__DOT__read_data1__DOT__mem_array[27]),32);
        bufp->chgIData(oldp+78,(vlSelf->top__DOT__read_data1__DOT__mem_array[28]),32);
        bufp->chgIData(oldp+79,(vlSelf->top__DOT__read_data1__DOT__mem_array[29]),32);
        bufp->chgIData(oldp+80,(vlSelf->top__DOT__read_data1__DOT__mem_array[30]),32);
        bufp->chgIData(oldp+81,(vlSelf->top__DOT__read_data1__DOT__mem_array[31]),32);
    }
    bufp->chgBit(oldp+82,(vlSelf->clk));
    bufp->chgBit(oldp+83,(vlSelf->rst));
    bufp->chgIData(oldp+84,(vlSelf->a0),32);
}
