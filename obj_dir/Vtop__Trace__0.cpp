...
void Vtop___024root__trace_chg_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    if (VL_UNLIKELY(vlSelf->__Vm_traceActivity[1U])) {
        ...
        bufp->chgBit(oldp+3,((vlSelf->top__DOT__ALU__DOT__rd1 
                              == vlSelf->top__DOT__ALU__DOT__ALUop2)));
        bufp->chgBit(oldp+4,(vlSelf->top__DOT__RegWrite));
        bufp->chgBit(oldp+5,(vlSelf->top__DOT__ALUsrc));
        bufp->chgBit(oldp+6,(vlSelf->top__DOT__ImmSrc));
        bufp->chgBit(oldp+7,(vlSelf->top__DOT__PCsrc));
        ...
        bufp->chgIData(oldp+14,((vlSelf->top__DOT__ALU__DOT__rd1 
