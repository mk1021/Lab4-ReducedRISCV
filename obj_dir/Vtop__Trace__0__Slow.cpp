...
VL_ATTR_COLD void Vtop___024root__trace_init_sub__TOP__0(Vtop___024root* vlSelf, VerilatedVcd* tracep) {
    ...
    tracep->declBus(c+54,"D_WIDTH", false,-1, 31,0);
...
VL_ATTR_COLD void Vtop___024root__trace_full_sub_0(Vtop___024root* vlSelf, VerilatedVcd::Buffer* bufp) {
    ...
    bufp->fullBit(oldp+4,((vlSelf->top__DOT__ALU__DOT__rd1 
                           == vlSelf->top__DOT__ALU__DOT__ALUop2)));
    bufp->fullBit(oldp+5,(vlSelf->top__DOT__RegWrite));
    bufp->fullBit(oldp+6,(vlSelf->top__DOT__ALUsrc));
    bufp->fullBit(oldp+7,(vlSelf->top__DOT__ImmSrc));
    bufp->fullBit(oldp+8,(vlSelf->top__DOT__PCsrc));
    ...
    bufp->fullIData(oldp+15,((vlSelf->top__DOT__ALU__DOT__rd1 
